# どこで: `src/interactive/runtime/draw_window_system.py`。
...
from src.interactive.draw_window import create_draw_window
...
from src.interactive.gl.draw_renderer import DrawRenderer
from src.core.pipeline import realize_scene
from src.interactive.gl.index_buffer import build_line_indices
