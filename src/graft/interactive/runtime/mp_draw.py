"""
どこで: `src/graft/interactive/runtime/mp_draw.py`。
...
from graft.core.parameters import FrameLabelRecord, FrameParamRecord
from graft.core.parameters.context import parameter_context_from_snapshot
from graft.core.scene import SceneItem, normalize_scene
...
def _draw_worker_main(
    ...
    # draw 側が `from graft.api import G/E` を行っていないケースでも動くようにする。
    import graft.api.effects  # noqa: F401
    import graft.api.primitives  # noqa: F401
