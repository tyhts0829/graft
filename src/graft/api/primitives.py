# どこで: `src/graft/api/primitives.py`。
...
from graft.core.parameters import caller_site_id

# primitive 実装モジュールをインポートしてレジストリに登録させる。
from graft.core.primitives import circle as _primitive_circle  # noqa: F401
from graft.core.primitives import grid as _primitive_grid  # noqa: F401
from graft.core.primitives import line as _primitive_line  # noqa: F401
